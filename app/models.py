...
class AssetFailureType(Base):
    ...
    asset_id: Mapped[int] = mapped_column(ForeignKey("asset.asset_id"), nullable=False)
...
class MaintenanceList(Base):
    ...
    maintenance_list_id: Mapped[int] = mapped_column(BigInteger, primary_key=True)
...
class OperationsMaintenanceList(Base):
    ...
    maintenance_list_id: Mapped[int] = mapped_column(ForeignKey("maintenance_list.maintenance_list_id"), primary_key=True)
...
class AssetMaintenanceList(Base):
    ...
    asset_maintenance_list_id: Mapped[int] = mapped_column(BigInteger, primary_key=True)
    asset_id: Mapped[int] = mapped_column(ForeignKey("asset.asset_id"), nullable=False)
    maintenance_list_id: Mapped[int] = mapped_column(ForeignKey("maintenance_list.maintenance_list_id"), nullable=False)


class AssetFailureTypeAssetMaintenanceList(Base):
    __tablename__ = "asset_failure_type_asset_maintenance_list"
    asset_failure_type_asset_maintenance_list_id: Mapped[int] = mapped_column(BigInteger, primary_key=True, autoincrement=True)
    asset_failure_type_id: Mapped[int] = mapped_column(ForeignKey("asset_failure_type.asset_failure_type_id"), nullable=False)
    asset_maintenance_list_id: Mapped[int] = mapped_column(ForeignKey("asset_maintenance_list.asset_maintenance_list_id"), nullable=False)
